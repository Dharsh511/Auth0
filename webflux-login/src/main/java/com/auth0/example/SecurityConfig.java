...
public class SecurityConfig {
    ...
    @Value("https://dev-wzekeqw0stfkmwzq.us.auth0.com/")
    private String issuer;
    @Value("zW30ocZKqRGDmJWiQq5FzVRjhvlTWAHX")
    ...
    public ServerLogoutSuccessHandler logoutSuccessHandler() {
        ...
        .fromHttpUrl(issuer + "v2/logout?client_id=zW30ocZKqRGDmJWiQq5FzVRjhvlTWAHX&returnTo=http://localhost:3000")
        .encode()
        .toUriString();
